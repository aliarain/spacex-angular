...
export type PastLauncherListQueryVariables = {
  limit: Scalars['Int'];
};


export type PastLauncherListQuery = (
  { __typename?: 'Query' }
...
export const PastLauncherListDocument = gql`
    query pastLauncherList($limit: Int!) {
  ...
  export class PastLauncherListGQL extends Apollo.Query<PastLauncherListQuery, PastLauncherListQueryVariables> {
    document = PastLauncherListDocument;
